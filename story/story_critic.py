...
class StoryCriticTool(BaseTool):
    ...
    def _run(
        ...
        if evaluation_number >= 8:
          result = ("Качество истории проверено критически и оценено.", evaluation_result, "Запусти подготовку упражнения align_trining")
        else:
          result = ("Качество истории проверено критически и оценено.", "Нужно создвать заново историю запустить функцию create_story")
        return result